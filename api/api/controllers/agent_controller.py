...
from api.controllers.util import json_response, XML_CONTENT_TYPE, JSON_CONTENT_TYPE
...
async def get_group_file_json(group_id: str, file_name: str, pretty: bool = False,
                              wait_for_complete: bool = False) -> ConnexionResponse:
...
async def get_group_file_xml(group_id: str, file_name: str, pretty: bool = False,
                             wait_for_complete: bool = False) -> ConnexionResponse:
    ...
    return ConnexionResponse(body=data["data"], content_type=XML_CONTENT_TYPE)
